        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="w-full bento-panel-light p-8">
              <p className="text-sm font-bold text-brand-navy mb-8 uppercase tracking-wider">India's Gas Demand vs. Feedstock Opportunity</p>
              
              <div className="flex flex-col gap-6">
                <div className="flex items-center gap-4">
                  <span className="w-32 text-sm font-medium text-gray-500">Current Demand</span>
                ...
                <div className="flex items-center gap-4">
                  <span className="w-32 text-sm font-medium text-gray-500">Feedstock Potential</span>
                  <div className="flex-1 bg-gray-100 h-4 rounded-full overflow-hidden">
                    <motion.div 
                      initial={{ width: 0 }}
